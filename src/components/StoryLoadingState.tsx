...
export const StoryLoadingState: React.FC<StoryLoadingStateProps> = ({
  ...
  return (
    ...
    >
      ...
      <Card className="w-full max-w-2xl bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-slate-900/95 border-2 border-amber-500/40 backdrop-blur-lg shadow-2xl relative overflow-hidden">
        ...
        <CardContent className="relative text-center space-y-8 py-12 px-8">
