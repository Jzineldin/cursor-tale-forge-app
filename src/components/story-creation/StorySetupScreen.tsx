        ...
        <CardContent className="space-y-8">
          ...
          <div className="flex flex-col gap-4">
            <Button
              ...
              className="w-full bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-400 text-white py-4 text-lg font-semibold shadow-xl hover:shadow-2xl transform hover:scale-[1.02] transition-all duration-300 border-2 border-amber-400/50"
